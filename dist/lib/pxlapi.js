...
})(SnapchatFilters = exports.SnapchatFilters || (exports.SnapchatFilters = {}));
var SafeSearch;
(function (SafeSearch) {
    SafeSearch["OFF"] = "off";
...
class PxlAPI extends pariah_1.Pariah {
    static = PxlAPI;
    constructor(token) {
        super(exports.PXLAPI_URL, { headers: { Authorization: `Bearer ${token}` } });
    }
    body(data, other = {}, outer = {}) {
        return Object.assign({ body: JSON.stringify(Object.assign({ images: data }, other)) }, outer);
    }
    async ajit(data) {
